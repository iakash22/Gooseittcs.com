        ...
        <div className='bg-bg-color relative'>
            ...
            <div className="bg-bg-color relative">
                <div className='md:max-w-[760px] mx-auto xl:max-w-[1160px] w-full px-4'>
                    <div className='grid place-content-center xl:gap-y-12 md:gap-y-8 gap-y-5 gap-x-6 xl:grid-cols-3 md:grid-cols-2 grid-cols-1 pb-5'>
                        <ImageCard
                            src={"https://www.gooseittc.com/wp-content/uploads/2023/06/download.jpg"}
                        ...
                        />
                        <ImageCard
                            src={"https://www.gooseittc.com/wp-content/uploads/2023/06/ts-id-graph.png"}
                        ...
                        />
                        <ImageCard
                            src={"https://www.gooseittc.com/wp-content/uploads/2023/06/lms-software-solutions-for-your-organization.png"}
                        ...
                        />
                        <ImageCard
                            src={"https://www.gooseittc.com/wp-content/uploads/2023/06/Elearning.60kb.png"}
                        ...
                        />
                        <ImageCard
                            src={"https://www.gooseittc.com/wp-content/uploads/2023/05/about3-img1.jpg"}
            ...
            <div className='bg-bg-color relative'>
                ...
                <div className='bg-[#F5F5F5]'>
                    <TrainingCard
                        src={"https://www.gooseittc.com/wp-content/uploads/2023/06/microsoft-logo.svg-450x450-1-300x300.png"}
                        title={"Microsoft"}
                ...
                <div className='bg-[#FFFFFF] md:my-[50px] my-5'>
                    <TrainingCard
                        src={"https://www.gooseittc.com/wp-content/uploads/2023/06/sap-cloud-815x815-1-300x300.png"}
                        title={"SAP IBP Cloud"}
                ...
                <div className='bg-[#F5F5F5] md:my-[50px] my-5'>
                    <TrainingCard
                        src={"https://www.gooseittc.com/wp-content/uploads/2023/06/oracle-cloud-400x400-1-300x300.jpg"}
                        title={"Oracle Cloud"}
                ...
                <div className='bg-[#FFFFFF] md:my-[50px] my-5'>
                    <TrainingCard
                        src={"https://www.gooseittc.com/wp-content/uploads/2023/06/scrum-450x446-1.png"}
                        title={"SCRUM"}
                ...
                <div className='bg-[#F5F5F5]'>
                    <TrainingCard
                        src={"https://www.gooseittc.com/wp-content/uploads/2023/06/multimedia-450x295-1.jpeg"}
